    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                float offsetXFromDown = mPtrIndicator.getOffsetXFromDown();
                float offsetYFromDown = mPtrIndicator.getOffsetYFromDown();
                if (offsetYFromDown > 0 && offsetYFromDown < mPagingTouchSlop) {
                    return dispatchTouchEventSupper(e);
                }
